...
from mmdet3d.bevformer.modules.encoder import BEVFormerEncoder
...
class BaseTransform(BaseModule):
    ...
    def forward(
        ...
        for img_meta in img_metas:
            ...
            camera_intrinsics.append(img_meta['cam_intrinsics'])
...
class BaseTransformV2(BaseModule):
    ...
    def forward(
        ...
        sensor_config = [fH, fW, rots, trans, intrins, post_rots, post_trans, lidar2ego_rots, lidar2ego_trans,
                         img_metas]
